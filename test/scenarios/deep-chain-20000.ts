// Run under runOnSmallStack("deep-chain-20000"): the depth-20000 chain from test/deep.test.ts re-run
// on a 256 KB V8 stack. It asserts directly; no printGraph, whose column-width math blows this stack.
